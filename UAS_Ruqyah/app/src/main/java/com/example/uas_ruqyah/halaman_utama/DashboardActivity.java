...
public class DashboardActivity extends Fragment {
    ...
    private void addData() {
        modelDashboardListMenus.add(new ModelDashboard("Call Center", "", R.string.call_centre, R.drawable.call,
                0, R.drawable.call));
        modelDashboardListMenus.add(new ModelDashboard("SMS", "", R.string.call_centre, R.drawable.sms,
                0, R.drawable.sms));
        modelDashboardListMenus.add(new ModelDashboard("Sosmed", "", R.string.call_centre, R.drawable.sosmed,
                0, R.drawable.sosmed));
        ...
        modelDashboardListLayanan.add(new ModelDashboard("", "Lokasi Peruqyah", R.string.text_totok, 0,
        ...
        modelDashboardListLayanan.add(new ModelDashboard("", "Kritik dan Saran",R.string.text_totok, 0,
                R.drawable.saran, R.drawable.saran));
    }
}
